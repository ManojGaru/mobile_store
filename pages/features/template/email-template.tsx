      ...
      <tbody>
        <tr>
          <td>
                ...
                <tr style={{ textAlign: "center" }}>
                  <td>
                    <a href="#">
                      <Image
                        alt=""
                        src="/images/email-temp/cosmetic.jpg"
                        style={{ width: "100%" }}
                      />
                    </a>
                  </td>
            ...
            <h5 style={{ textAlign: "center", margin: "10px", color: "#777" }}>
