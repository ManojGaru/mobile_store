...
const ProductBox2: React.FC<productType> = (data) => {
  ...
  const plusQty = () => {
    if (Number(data.stock) >= Number(quantity)) {
      const qty = quantity + 1;
      setQuantity(qty);
      updateQty(data.item, qty);
    } else {
        ...
        <div className="product-box">
          ...
          <div className="addtocart_btn">
            <button
              ...
              onClick={() => {
                Number(data?.stock) > 0
                  ? (setOpenQty(true), updateQty(data, quantity))
                  : "";
              }}
            >
              add to cart
            ...
            <div className="col-lg-6 rtl-text">
              <div className="product-right">
                ...
                <div className="product-description border-product">
                  ...
                  {stock1 !== "InStock" ? (
                    <span className="instock-cls">Out Of Stock</span>
                  ) : (
                    ""
                  )}
                  ...
                  <div className="qty-box">
                    <div className="input-group">
                      ...
                      <input
                        ...
                        value={quantity}
                        onChange={() => updateQty(data.item, quantity)}
                      />
                      <span className="input-group-prepend">
                        <button
                          type="button"
