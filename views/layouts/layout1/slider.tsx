...
const banners = [
  {
    img1: "/images/common/61SVCZk93gL._SX679_.jpg",
    img2: "/images/common/71aiqeP-APL._SX679_.jpg",
    title1: "mi",
    title2: "Mobile",
  ...
  {
    img1: "/images/common/71MI4QbQIvL._SX679_.jpg",
    img2: "/images/common/612IqV1YEjL._SX679_.jpg",
    title1: "big",
    title2: "Sale",
  ...
  {
    img1: "/images/common/612IqV1YEjL._SX679_.jpg",
    img2: "/images/common/612IqV1YEjL._SX679_.jpg",
    title1: "camera",
    title2: "Sale",
...
const BannerList: React.FC<sliderProps> = ({ banner }) => {
  ...
  return (
    <div
      className="slider-banner p-center slide-banner-1"
