            ...
            <ul className={`nav-cat title-font ${leftMenu ? "openmenu" : ""}`}>
              ...
              <li>
                <a href="/collections/leftsidebar?category=ELECTRONIC">
                  <Media
                    src="/images/layout-1/nav-img/02.png"
                    alt="category-product"
                    className="img-fluid"
                  />
                  Samsung
              ...
              <li>
                <a href="/collections/leftsidebar?category=PETS">
                  <Media
                    src="/images/layout-1/nav-img/03.png"
                    alt="category-product"
                    className="img-fluid"
                  />
                  Oppo
              ...
              <li>
                <a href="/collections/leftsidebar?category=FLOWER">
                  <Media
                    src="/images/layout-1/nav-img/04.png"
                    alt="category-product"
                    className="img-fluid"
                  />{" "}
                  FLOWER
              ...
              <li>
                <a href="/collections/leftsidebar?category=FURNITURE">
                  <Media
                    src="/images/layout-1/nav-img/05.png"
                    alt="category-product"
                    className="img-fluid"
                  />
                  MI
              ...
              <li>
                <a href="/collections/leftsidebar?category=BEAUTY">
                  <Media
                    src="/images/layout-1/nav-img/06.png"
                    alt="category-product"
                    className="img-fluid"
                  />
                  Moto
              ...
              <li>
                <a href="/collections/leftsidebar?category=VEGETABLES">
                  <Media
                    src="/images/layout-1/nav-img/07.png"
                    alt="category-product"
                    className="img-fluid"
                  />
                  Vivo
              ...
              <li>
                <a href="/collections/leftsidebar?category=JEWELLWEY">
                  <Media
                    src="/images/layout-1/nav-img/08.png"
                    alt="category-product"
                    className="img-fluid"
                  />
                  Redmi
              ...
              <li>
                <a href="/collections/leftsidebar?category=BAGS">
                  <Media
                    src="/images/layout-1/nav-img/09.png"
                    alt="category-product"
                    className="img-fluid"
                  />{" "}
                  BAGS
              ...
              <li>
                <a href="/collections/leftsidebar?category=WATCH">
                  <Media
                    src="/images/layout-1/nav-img/10.png"
                    alt="category-product"
                    className="img-fluid"
                  />{" "}
                  WATCH
              ...
              <li>
                <a href="/collections/leftsidebar?category=TOOLS">
                  <Media
                    src="/images/layout-1/nav-img/11.png"
                    alt="category-product"
                    className="img-fluid"
                  />{" "}
                  TOOLS
              ...
              <li>
                <a href="/collections/leftsidebar?category=KIDS">
                  <Media
                    src="/images/layout-1/nav-img/12.png"
                    alt="category-product"
                    className="img-fluid"
                  />{" "}
                  KIDS
